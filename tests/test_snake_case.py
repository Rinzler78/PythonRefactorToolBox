...
class TestSnakeCase(unittest.TestCase):
    ...
    def test_to_snake_case(self):
        test_cases = {
            ...
            "numeric_and_alphabets": (
                "Num3r1c4l and Alph4b3t!",
                "num3r1c4l_and_alph4b3t",
            ),
            "leading_and_trailing_spaces": (
                "  Leading and trailing spaces  ",
                "leading_and_trailing_spaces",
            ),
            "hyphens_and_underscores": (
                "hyphens-and_underscores",
                "hyphens_and_underscores",
            ),
            "consecutive_spaces": ("consecutive    spaces", "consecutive_spaces"),
            "camel_case_with_digits": (
                "CamelCase123WithDigits",
                "camel_case123_with_digits",
            ),
            "empty_string": ("", ""),
            "spaces_only": ("     ", ""),
        ...
        for input_str, expected_result in test_cases.values():
            self.assertEqual(to_snake_case(input_str), expected_result)
